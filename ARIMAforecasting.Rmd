...
con la prueba de Dickey Fuller (DF) podemos observar que la serie no es estacionaria, ya que se tiene el siguiente p-valor mayor a 0.05, considerando un nivel de significancia estadística del 5%. 
...
A continuación se presenta la gráfica ACF de esta serie diferenciada una vez. 
...
Se presenta la prueba Dickey Fuller para la serie con una diferencia. El p-valor muestra que es no estacionaria al 5% de nivel de significancia estadística. sin embargo, parece ser estacionaria el 10% de significancia. 
...
A continuación se presenta la prueba de Dickey Fuller con dos diferencias.  Presenta un p-valor menor a 0.05, es decir, se rechaza la hipótesis nula de no estacionariedad. 
